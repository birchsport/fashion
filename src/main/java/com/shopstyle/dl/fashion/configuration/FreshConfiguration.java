...
public class FreshConfiguration {
	...
	private static final Logger log = org.slf4j.LoggerFactory.getLogger(FreshConfiguration.class);
...
//	@Bean
	public MultiLayerNetwork createNetwork() {
		...
		MultiLayerNetwork network = buildNetwork(rate);
	...
	private MultiLayerNetwork buildNetwork(double rate) {
